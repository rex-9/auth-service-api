# app/controllers/v1/user_versions_controller.rb

class V1::UserVersionsController < V1::ApplicationController
  # POST /v1/versions/user-version
  def create_install
    record = UserVersionService.create(
      user: current_user,
    ...
    render_json_response(
      ...
      data: { user_version: UserVersionSerializer.new(record).serializable_hash[:data][:attributes] }
    )
