...
module SortConstants
  ...
  module Columns
    ...
    APP_VERSION = %w[created_at number title status released_at discarded_at install_count].freeze
    APP_INSTALL = %w[last_seen_at number platform created_at].freeze
